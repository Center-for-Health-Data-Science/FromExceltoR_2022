...
This part might be easier to follow from the Quarto document.

::: {style="display: flex; gap: 10px;"}
<a href="./exercise4_PART1.qmd" download="exercise4_PART1.qmd"> <button class="btn small-button" style="background-color: #18bc9c; color: white; border: none; padding: 10px 20px; border-radius: 5px;"> Download the Quarto script </button> </a>
:::
